...
public class AdminManagementTests extends AbstractTest {
	...
	public void createAdmin() throws Exception {
		...
		admin.setMobileNumber("8807406815");
	...
	public void showTripsForDates() throws Exception {
		String uri = "/admin/fordays/62/2023-01-15T04:50:26.838Z/2023-02-15T04:50:26.838Z";
		MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn();
		int status = mvcResult.getResponse().getStatus();
		assertEquals(200, status);
		String content = mvcResult.getResponse().getContentAsString();
		TripBooking tripList[] = super.mapFromJson(content, TripBooking[].class);
		assertEquals(62, tripList[0].getCustomer().getCustomerId());
		assertEquals(true, tripList[0].getFromDateTime().isAfter(LocalDateTime.parse("2023-01-15T04:50:26.838")));
		assertEquals(true, tripList[0].getToDateTime().isBefore(LocalDateTime.parse("2021-02-15T04:50:26.838")));
	}
